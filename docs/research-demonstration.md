...
From the repository root, bootstrap the managed environment once:
...
```powershell
& services/backend/.venv/Scripts/python.exe -m uvicorn cci.main:app --app-dir services/backend/src --host 127.0.0.1 --port 8000
```
