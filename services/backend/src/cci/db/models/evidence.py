...
class Evidence(Base, UUIDPrimaryKeyMixin, ImmutableModelMixin, TimestampMixin):
    ...
    is_positive_support: Mapped[bool] = mapped_column(
    ...
    factor_verification_level: Mapped[float] = mapped_column(
        Float, nullable=False
    )  # v_e
    factor_depth_specificity: Mapped[float] = mapped_column(
        Float, nullable=False
    )  # x_e
    factor_source_reliability: Mapped[float] = mapped_column(
        Float, nullable=False
    )  # r_s
...
class EvidenceCapabilityLink(
    Base, UUIDPrimaryKeyMixin, ImmutableModelMixin, TimestampMixin
):
    ...
    evidence: Mapped["Evidence"] = relationship(
        "Evidence", back_populates="capability_links"
    )
