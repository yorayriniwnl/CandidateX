...
def inspect_git_blobs(fetcher, owner, repo, sha, workspace, max_blobs: int = 50):
    """For oversized archives, performs an iterative deep scan using the immutable Git tree (Fix 24)."""
    from cci.live.deep_scan import iterative_deep_scan_git_blobs
    return iterative_deep_scan_git_blobs(fetcher, owner, repo, sha, workspace, max_blobs=max_blobs)
