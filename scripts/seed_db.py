...
def seed_database(db_url: str, reset: bool = False, samples_count: int = 6) -> None:
    ...
    try:
        ...
        org_acme = repo.save_organization(
            session=session,
            name="Example Systems Organization",
        ...
        user1 = repo.save_user(
            ...
            email="recruiter01@example.invalid",
        ...
        user2 = repo.save_user(
            session=session,
            organization_id=org_acme.id,
            email="recruiter02@example.invalid",
        ...
        user3 = repo.save_user(
            ...
            email="recruiter03@example.invalid",
        ...
        cohorts = [
            {
                ...
                "name": "Demo Candidate 01",
                "email": "candidate01@example.invalid",
            ...
            },
            {
                ...
                "name": "Demo Candidate 02",
                "email": "candidate02@example.invalid",
            ...
            },
            {
                ...
                "name": "Demo Candidate 03",
                "email": "candidate03@example.invalid",
            ...
            },
            {
                ...
                "name": "Demo Candidate 04",
                "email": "candidate04@example.invalid",
            ...
            },
            {
                ...
                "name": "Demo Candidate 05",
                "email": "candidate05@example.invalid",
            ...
            },
            {
                ...
                "name": "Demo Candidate 06",
                "email": "candidate06@example.invalid",
                "role": CanonicalRole.BACKEND,
                "org_id": org_acme.id,
                "cv_file": "",
                "jd_role": CanonicalRole.BACKEND,
