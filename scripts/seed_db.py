...
def seed_database(db_url: str, reset: bool = False, samples_count: int = 6) -> None:
    ...
    try:
        ...
        user1 = repo.save_user(
            ...
            hashed_password="!disabled-demo-user-no-local-auth!",
        ...
        cohorts = [
            {
                ...
                "evidence": [
                    create_evidence_record("https://example.invalid/synthetic/distributed-payment-engine", CapabilityKey.BACKEND_ENGINEERING, 88.0, artifact_path="src/reconciler.go"),
                    create_evidence_record("https://example.invalid/synthetic/distributed-payment-engine", CapabilityKey.BACKEND_ENGINEERING, 92.0, artifact_path="src/outbox/publisher.go"),
                    create_evidence_record("https://example.invalid/synthetic/pg-partition-manager", CapabilityKey.DATABASE_ENGINEERING, 89.0, artifact_path="alembic/versions/partition_table.py"),
                    create_evidence_record("https://example.invalid/synthetic/pg-partition-manager", CapabilityKey.DATABASE_ENGINEERING, 85.0, artifact_path="src/partition/manager.py"),
                    create_evidence_record("https://example.invalid/synthetic/distributed-payment-engine", CapabilityKey.TESTING_QUALITY, 87.0, artifact_path="tests/integration/reconciler_test.go"),
                    create_evidence_record("https://example.invalid/synthetic/distributed-payment-engine", CapabilityKey.SOFTWARE_ARCHITECTURE, 90.0, artifact_path="docs/adr/0002-transactional-outbox.md"),
                    create_evidence_record("https://example.invalid/synthetic/distributed-payment-engine", CapabilityKey.DEVOPS_CLOUD, 78.0, artifact_path="deploy/k8s/deployment.yaml"),
                ],
            },
            {
                ...
                "evidence": [
                    create_evidence_record("https://example.invalid/synthetic/a11y-kit-react", CapabilityKey.FRONTEND_ENGINEERING, 93.0, artifact_path="src/primitives/dialog.tsx"),
                    create_evidence_record("https://example.invalid/synthetic/a11y-kit-react", CapabilityKey.FRONTEND_ENGINEERING, 91.0, artifact_path="src/primitives/combobox.tsx"),
                    create_evidence_record("https://example.invalid/synthetic/next-vitals-booster", CapabilityKey.FRONTEND_ENGINEERING, 89.0, artifact_path="src/vitals/prefetch.ts"),
                    create_evidence_record("https://example.invalid/synthetic/a11y-kit-react", CapabilityKey.TESTING_QUALITY, 94.0, artifact_path="tests/a11y/axe.spec.ts"),
                    create_evidence_record("https://example.invalid/synthetic/a11y-kit-react", CapabilityKey.SOFTWARE_ARCHITECTURE, 86.0, artifact_path="docs/design-system-tokens.md"),
                    create_evidence_record("https://example.invalid/synthetic/a11y-kit-react", CapabilityKey.DOCUMENTATION_COMMUNICATION, 90.0, artifact_path="README.md"),
                ],
            },
            {
                ...
                "evidence": [
                    create_evidence_record("https://example.invalid/synthetic/fast-alignment", CapabilityKey.MACHINE_LEARNING, 94.0, artifact_path="src/calibration/dpo_loss.py"),
                    create_evidence_record("https://example.invalid/synthetic/fast-alignment", CapabilityKey.MACHINE_LEARNING, 90.0, artifact_path="src/evaluation/leakage_guard.py"),
                    create_evidence_record("https://example.invalid/synthetic/vector-gateway-service", CapabilityKey.BACKEND_ENGINEERING, 86.0, artifact_path="service/grpc_server.py"),
                    create_evidence_record("https://example.invalid/synthetic/vector-gateway-service", CapabilityKey.SOFTWARE_ARCHITECTURE, 88.0, artifact_path="docs/architecture_grpc.md"),
                    create_evidence_record("https://example.invalid/synthetic/fast-alignment", CapabilityKey.TESTING_QUALITY, 85.0, artifact_path="tests/test_dpo_gradient.py"),
                ],
            },
            {
                ...
                "evidence": [
                    create_evidence_record("https://example.invalid/synthetic/tf-blast-guard", CapabilityKey.DEVOPS_CLOUD, 95.0, artifact_path="policies/rds_drop_guard.rego"),
                    create_evidence_record("https://example.invalid/synthetic/k8s-region-failover", CapabilityKey.DEVOPS_CLOUD, 92.0, artifact_path="controller/main.go"),
                    create_evidence_record("https://example.invalid/synthetic/tf-blast-guard", CapabilityKey.SECURITY, 91.0, artifact_path="src/analyzer/blast_radius.go"),
                    create_evidence_record("https://example.invalid/synthetic/k8s-region-failover", CapabilityKey.SOFTWARE_ARCHITECTURE, 89.0, artifact_path="docs/failover_sequence.md"),
                    create_evidence_record("https://example.invalid/synthetic/tf-blast-guard", CapabilityKey.TESTING_QUALITY, 88.0, artifact_path="tests/e2e/blast_test.go"),
                ],
            },
            {
                ...
                "evidence": [
                    create_evidence_record("https://example.invalid/synthetic/type-safe-stack", CapabilityKey.FRONTEND_ENGINEERING, 87.0, artifact_path="apps/web/pages/index.tsx"),
                    create_evidence_record("https://example.invalid/synthetic/type-safe-stack", CapabilityKey.BACKEND_ENGINEERING, 88.0, artifact_path="packages/api/src/router.ts"),
                    create_evidence_record("https://example.invalid/synthetic/type-safe-stack", CapabilityKey.DATABASE_ENGINEERING, 84.0, artifact_path="prisma/schema.prisma"),
                    create_evidence_record("https://example.invalid/synthetic/type-safe-stack", CapabilityKey.TESTING_QUALITY, 86.0, artifact_path="tests/trpc/mutations.test.ts"),
                    create_evidence_record("https://example.invalid/synthetic/collab-canvas", CapabilityKey.SOFTWARE_ARCHITECTURE, 89.0, artifact_path="docs/crdt_model.md"),
                ],
            },
            {
                "id": UUID("77777777-7777-7777-7777-777777777777"),
                "name": "Example Candidate Six (Contradiction Demo)",
