...
test('homepage routes into the research lab and the workspace has no fabricated initial dossier', async ({ page }) => {
  await page.goto('/');
  await expect(page).toHaveURL(/\/$/);
  await page.getByRole('link', { name: 'Research Lab', exact: true }).first().click();
