...
export default function HomePage() {
  ...
  return (
    <div className="workspace-shell min-h-screen flex font-[family-name:var(--font-sans)]">
      {/* ============================================================
          Sidebar Navigation
          ============================================================ */}
      <aside
      ...
      >
        {/* Logo */}
        <Link href="/" aria-label="CandidateX home" className="workspace-sidebar__brand p-4 flex items-center gap-3">
          ...
          {sidebarExpanded && (
            ...
            >
              ...
              <div className="text-[10px] text-indigo-200 font-medium whitespace-nowrap">Evaluation Workspace</div>
              <div className="text-[10px] text-slate-500 font-mono whitespace-nowrap">v1.0.0 · directory · dossiers · comparison</div>
            </motion.div>
          )}
        </Link>

        {/* Nav Items */}
        <nav className="workspace-sidebar__nav flex-1 px-2.5 py-2 space-y-1" aria-label="Workspace sections">
          {NAV_ITEMS.map((item) => {
        ...
        {/* Bottom actions */}
        <div className="workspace-sidebar__footer p-2.5 space-y-1 border-t border-white/[0.04]">
          <button
            type="button"
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <div
        className={`workspace-main flex-1 flex flex-col min-h-screen transition-all duration-300 ${
      ...
      >
        ...
        <header className="sticky top-0 z-30 glass-strong border-b border-white/[0.04]">
          <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <Link href="/" className="hidden sm:inline-flex items-center rounded-lg px-2.5 py-1.5 text-xs text-slate-400 hover:bg-white/[0.04] hover:text-white transition-colors">
                Command center
              </Link>
            </div>
        ...
        <main className="flex-1 max-w-7xl mx-auto px-6 py-6 w-full">
          ...
          <div className="mb-5 rounded-xl border border-indigo-400/30 bg-indigo-950/40 p-4 text-sm text-indigo-100">
            ...
            {' '}<Link href="/research-demo" className="underline">Open the executable paper demonstration</Link>.
          </div>
