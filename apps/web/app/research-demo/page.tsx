...
export default function ResearchDemonstration() {
  ...
  function exportSnapshot() {
    ...
    // Chromium can take longer than a second to materialize a download while
    // the result is still being rendered. Keep the object URL alive long
    // enough for the browser to finish copying the blob.
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#030712] text-slate-100 pb-16 font-sans">
      <PlatformHeader surface="research" status="synthetic" />

      <div className="px-4 md:px-8 lg:px-16">
        <nav className="flex flex-wrap gap-4 border-b border-white/[0.05] py-4 text-xs text-indigo-200" aria-label="Research sections">
          <a href="#method" className="hover:text-indigo-100">The method</a>
          <a href="#benchmarks" className="hover:text-indigo-100">Experiments</a>
        </nav>
