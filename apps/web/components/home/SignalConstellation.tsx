export function SignalConstellation() {
  return (
    <>
      <div className="signal-constellation" data-testid="signal-observatory" aria-hidden="true">
      ...
      <p className="sr-only">Candidate claims move through public evidence into capabilities and focused interview questions.</p>
    </>
  );
}
