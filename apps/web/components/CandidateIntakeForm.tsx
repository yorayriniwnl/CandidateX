...
const CANONICAL_PRESETS: CandidatePreset[] = [
  {
    ...
    deployments: ['https://portfolio.demo-candidate-01.invalid'],
    skills: ['Python', 'Go', 'PostgreSQL', 'Kafka', 'Docker', 'Distributed Systems'],
    file: 'demo-candidate-01-backend-cv.txt',
  },
  {
    ...
    deployments: ['https://portfolio.demo-candidate-02.invalid'],
    skills: ['TypeScript', 'React', 'Next.js', 'Web Vitals', 'WAI-ARIA', 'Tailwind CSS'],
    file: 'demo-candidate-02-frontend-cv.txt',
  },
  {
    ...
    deployments: ['https://portfolio.demo-candidate-03.invalid'],
    skills: ['Python', 'PyTorch', 'Transformers', 'vLLM', 'Qdrant', 'Model Evaluation'],
    file: 'demo-candidate-03-ml-cv.txt',
  },
  {
    ...
    deployments: ['https://portfolio.demo-candidate-04.invalid'],
    skills: ['Kubernetes', 'Terraform', 'Prometheus', 'ArgoCD', 'eBPF', 'AWS'],
    file: 'demo-candidate-04-sre-cv.txt',
  },
  {
    ...
    deployments: ['https://portfolio.demo-candidate-05.invalid'],
    skills: ['React', 'Next.js', 'Node.js', 'PostgreSQL', 'Redis', 'tRPC'],
    file: 'demo-candidate-05-fullstack-cv.txt',
  },
  {
    ...
    file: 'demo-candidate-06-conflict-cv.txt',
  },
];
