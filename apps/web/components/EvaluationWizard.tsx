...
const QUICK_DEMO_PROFILES: QuickDemoProfile[] = [
  {
    ...
    manifest: {
      ...
      full_name: 'Demo Candidate 01',
      primary_email: 'candidate01@example.invalid',
      github_usernames: ['demo-candidate-01'],
      github_repositories: [
      ...
      deployment_urls: ['https://portfolio.demo-candidate-01.invalid'],
      portfolio_urls: [],
  ...
  },
  {
    ...
    manifest: {
      ...
      full_name: 'Demo Candidate 02',
      primary_email: 'candidate02@example.invalid',
      github_usernames: ['demo-candidate-02'],
      github_repositories: [
        'https://github.invalid/demo-candidate-02/a11y-kit-react',
        'https://github.invalid/demo-candidate-02/next-vitals-booster',
      ],
      deployment_urls: ['https://portfolio.demo-candidate-02.invalid'],
      portfolio_urls: [],
  ...
  },
  {
    ...
    manifest: {
      ...
      full_name: 'Demo Candidate 06',
      primary_email: 'candidate06@example.invalid',
      github_usernames: ['demo-candidate-06'],
      github_repositories: [
        'https://github.invalid/demo-candidate-06/toy-distributed-counter',
        'https://github.invalid/demo-candidate-06/quick-rest-starter',
      ],
      deployment_urls: ['https://portfolio.demo-candidate-06.invalid'],
      portfolio_urls: [],
