...
const QUICK_DEMO_PROFILES: QuickDemoProfile[] = [
  ...
  },
  {
    ...
    manifest: {
      ...
      full_name: 'Example Candidate Two',
      primary_email: 'candidate-two@example.invalid',
      github_usernames: ['synthetic-candidate-two'],
      github_repositories: [
        'https://example.invalid/synthetic/a11y-kit-react',
        'https://example.invalid/synthetic/next-vitals-booster',
      ],
      deployment_urls: ['https://example.invalid/profile-two'],
      portfolio_urls: [],
  ...
  },
  {
    ...
    manifest: {
      ...
      full_name: 'Example Candidate Six',
      primary_email: 'candidate-six@example.invalid',
      github_usernames: ['synthetic-candidate-six'],
      github_repositories: [
        'https://example.invalid/synthetic/toy-distributed-counter',
        'https://example.invalid/synthetic/quick-rest-starter',
      ],
      deployment_urls: ['https://example.invalid/profile-six'],
      portfolio_urls: [],
